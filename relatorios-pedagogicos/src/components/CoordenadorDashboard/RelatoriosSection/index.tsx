...
// Tipo para o status baseado no que o Prisma espera
type StatusRelatorio = 'RASCUNHO' | 'ENVIADO' | 'REVISADO';
...
export default function RelatoriosSection() {
  ...
  // Função para atualizar o status no estado local
  const atualizarStatusRelatorio = (novoStatus: StatusRelatorio) => {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => atualizarStatusRelatorio(e.target.value as StatusRelatorio)}
