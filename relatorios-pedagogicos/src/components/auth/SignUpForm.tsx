  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(errorData.error || 'Erro ao realizar cadastro. Tente novamente.');
      }
    } catch (error) {
              ...
              <div className="space-y-5">
                ...
                <div>
                  <button 
                    type="submit"
                    disabled={isSubmitting}
                    className="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600 disabled:bg-brand-400 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
